        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile">
                <div class="user-pro-body">
                    <div><img src="https://store-images.s-microsoft.com/image/apps.28411.13510798887593857.411c7070-8254-4bc7-9822-93212e9b3eaa.d5650289-0ad1-4560-ac30-38a18a1847bb" alt="user-img" class="img-circle"></div>
                    <div class="dropdown">
                ...
                <ul id="sidebarnav">
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Ecommerce <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                        <ul aria-expanded="false" class="collapse">
                            ...
                            <li><a href="brand">Nhãn hiệu</a></li>
