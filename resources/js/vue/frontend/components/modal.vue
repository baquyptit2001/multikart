                            ...
                            <div class="modal-box product-summary">
                                ...
                                <div class="product-action d-flex flex-row align-items-center mb--30 mb-md--20">
                                    ...
                                    <button type="button" class="btn btn-style-1 btn-semi-large add-to-cart"
                                        onclick="window.location.href='https://demo.hasthemes.com/airi-preview/airi/cart.html'">
                                        Add To Cart
                                    </button>
                                ...
                                <div
                                    ...
                                    <div class="product-meta">
                                        <span class="sku_wrapper font-size-12">SKU: <span class="sku">REF.
                                                LA-887</span></span>
                                        <span class="posted_in font-size-12">Categories: <a href="https://demo.hasthemes.com/airi-preview/airi/shop-sidebar.html"
